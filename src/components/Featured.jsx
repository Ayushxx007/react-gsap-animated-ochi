    ...
    <div className="w-full py-20">
        <div className="w-full px-20 border-b-[1px] border-zinc-800 pb-20">
            ...
            <div className="cards w-full flex gap-15 mt-10">
                ...
                <h1 className="absolute text-[#CDEA68] left-full -translate-x-1/2 top-1/2 -translate-y-1/2    z-[9] leading-none font-['Founders_Grotesk_X-Condensed']   text-8xl">FYDE</h1>
                ...
                <div className=" relative  cardcontainer rounded-xl w-1/2 h-[75vh] bg-red-500">
                <h1 className="absolute text-[#CDEA68] right-full translate-x-1/2 top-1/2 -translate-y-1/2    z-[9] leading-none font-['Founders_Grotesk_X-Condensed']   text-8xl">VISE</h1>
